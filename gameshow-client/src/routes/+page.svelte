	...
	<div class="border rounded-xl w-1/3 p-10">
		...
		<div class="mt-5">
			<div class="flex flex-col px-2 py-1">
				...
				<input class="rounded bg-gray-600" id="usernameInput" disabled={isLoading} bind:value={username} type="text" />
			</div>
			<div class="flex flex-col px-2 py-1">
				<label class="font-bold mb-2" for="usernameInput">Webcam Link:</label>
				<input class="rounded bg-gray-600" id="usernameInput" disabled={isLoading} bind:value={link} type="text" />
			</div>
			<div class="flex flex-col px-2 py-1">
